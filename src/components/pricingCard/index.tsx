                    ...
                    <Box sx={{ ...pricingcardstyle.billSx }}>
                      ...
                      <Box sx={{...pricingcardstyle.emailInputSx  }}>
                        <InputField
                          ...
                          error={state?.error?.email?.length > 0 ? true : false}
                      ...
                      <Box sx={{ ...pricingcardstyle.cardPaymentSx }}>
                        <Box>
                          <InputField
                            ...
                            error={state?.error?.cardNumber?.length > 0 ? true : false}
                        ...
                        <Box sx={{display:'flex'}}>
                          ...
                          <InputField
                            ...
                            error={state?.error?.expiry?.length > 0 ? true : false}
                         ...
                         <InputField
                            ...
                            error={state?.error?.ccv?.length > 0 ? true : false}
